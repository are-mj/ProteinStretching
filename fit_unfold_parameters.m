function [theta,theta_std,resnorm,Fplot,pdplot] = fit_unfold_parameters(F,pd,T,theta0,par)
...
%     Fdotmean may be caclulated by probability_density.m
%     nu:  1/2: quatratic potentisl, 2/3 cubic potential
%     model alternatives:
%       'DHS' (Dodko, Hummer & Szabo, 2006)  
%       'CHS' (Cossio, Hummer & Szabo, 2016) 
%   F and pd may be calculated by probability_density.m
% Output:
...
% Version 4.0, August 2023
  ...
  probfun = @(thetacalc,F)unfold_probability_model(thetacalc,F,T,par);
